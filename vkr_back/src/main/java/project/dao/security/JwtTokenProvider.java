...
import project.dao.security.exception.JwtAuthenticationException;
...
public class JwtTokenProvider {
    ...
    public boolean validateToken(String token) {
        try {
            ...
            throw new JwtAuthenticationException("JWT токен истек или недействителен", HttpStatus.UNAUTHORIZED);
        }
    }
